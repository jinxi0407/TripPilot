...
from evals.v1_2_2.evaluator import evaluate, summarize
from evals.v1_2_2.schema import DIRECTORY, ROOT, file_hash, load_cases
...
def signature(settings):
    ...
    files += (
        ...
        + [ROOT / "evals/v1_2/benchmark_50.jsonl", ROOT / "evals/v1_2/schema.py"]
    )
